  ...
  return (
    <Stack>
      <Group justify="space-between">
        ...
        <Tooltip label={isConnected ? "Connected to server" : "Connect to a server to enable sync"}>
          <Badge
            color={isConnected ? "green" : "red"}
            leftSection={isConnected ? <IconCloud size={16} /> : <IconCloudOff size={16} />}
          >
      ...
      <Paper p="md" withBorder>
        <Stack>
          ...
          <TextInput label="Device ID" value={deviceId} onChange={(e) => handleDeviceIdChange(e.currentTarget.value)} />
          <Group>
            ...
            <Button variant="light" leftSection={<IconDownload size={16} />} onClick={handleExportData}>
              Export Data
            </Button>
            <Button variant="light" color="red" leftSection={<IconTrash size={16} />} onClick={handleClearCache}>
              Clear Cache
            </Button>
          </Group>
        </Stack>
      ...
      {/* Confirmation Modal */}
      <Modal opened={confirmModalOpen} onClose={() => setConfirmModalOpen(false)} title={confirmAction?.title}>
        <Stack>
